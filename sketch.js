...
function setup() 
{
  ...
  star = createSprite(200,340,50,50);
  star.addImage(star_img);
  star.scale = 0.02;

  star2 = createSprite(120,200,50,50);
  ...
  display_star.addAnimation('one_star', one_star);
  display_star.addAnimation('two_star', two_star);
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star,20)===true) {
    star.visible = false;
    display_star.changeAnimation(one_star); 
   }
